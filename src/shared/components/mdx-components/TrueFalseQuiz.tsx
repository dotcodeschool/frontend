    ...
    if (submitted) {
      ...
      cls +=
        selected === value
          ...
          : "border-border text-content-muted hover:border-content-faint";
    }
    return cls;
  };
      ...
      <div className="flex gap-3 mb-4">
        ...
        >
          ...
          {submitted && correct === true && (
            <FaCheckCircle className="inline ml-1 w-3.5 h-3.5" />
          )}
          {submitted && selected === true && !correct && (
            <FaExclamationTriangle className="inline ml-1 w-3.5 h-3.5" />
          )}
        </button>
        <button
