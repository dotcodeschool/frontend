...
estimated_time: 8 # Estimated time to complete in hours
...
<img
  src="https://github.com/shawntabrizi/substrate-collectables-workshop/blob/master/screenshot.png?raw=true"
  width="400px"
/>
