...
<QuizGroup title="JavaScript Fundamentals Quiz" description="Test your knowledge of JavaScript basics">
  <Quiz
...
<Quiz
  ...
  explanation={
    <>
      <p>JSX stands for JavaScript XML. It is a syntax extension for JavaScript recommended by React for describing what the UI should look like.</p>
      <p>JSX produces React "elements" that can be rendered to the DOM. It looks like HTML but comes with the full power of JavaScript.</p>
