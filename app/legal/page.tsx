...
export const metadata = {
  ...
  description:
    "Terms of Service, Privacy Policy, and Disclaimer for DotCodeSchool",
};
        ...
        <VStack spacing={8} align="stretch">
          <Box textAlign="center" mb={8}>
            ...
            <Text fontSize="lg" color="gray.500">
              These documents govern your use of DotCodeSchool and explain how
              we handle your data
            </Text>
          </Box>
          ...
          <Box mt={12} textAlign="center">
            ...
            <Text>
              DotCodeSchool is an open-source educational platform funded by the
              Polkadot Treasury. We are dedicated to providing high-quality
              learning resources for blockchain development.
            </Text>
            <Text mt={4}>
              As an open-source project, we are committed to transparency in all
              aspects of our operation, including our legal policies. These
              documents are designed to clearly communicate your rights and our
              responsibilities.
            </Text>
          </Box>
        </VStack>
