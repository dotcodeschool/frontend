...
export interface TypeCourseModuleFields {
    ...
    level: EntryFieldTypes.Symbol<"Advanced" | "Beginner" | "Expert" | "Intermediate">;
...
export type TypeCourseModuleSkeleton = EntrySkeletonType<TypeCourseModuleFields, "courseModule">;
export type TypeCourseModule<Modifiers extends ChainModifiers, Locales extends LocaleCode = LocaleCode> = Entry<TypeCourseModuleSkeleton, Modifiers, Locales>;
